# Guide to use
all the files in this repo (except this one) should be put into 
...
all the files come from:
C:Windows/System32/DriverStore/FileRepository


after you add files run this command:
chmod -R 0644 /lib/firmware/qcom/x1e80100/device_path="LENOVO/83ED"


# this comes from ubuntus extract firmware script:
```bash
#!/bin/bash
